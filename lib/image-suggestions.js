...
// it, which is worse than no image at all. Only 'after-intro' puts the figure
// where there is prose left to wrap around it.
//
...
const POSITION_LAYOUTS = {
    'after-intro': ['band', 'inline-left', 'inline-right'],
};
const DEFAULT_POSITION = 'after-intro';
...
- "position" is ALWAYS "after-intro". There is no other option — the image sits beside the opening prose of its section, which is the only place body text can wrap around it.
