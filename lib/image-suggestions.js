...
[
  {
    "section_heading": "the EXACT text of one ## heading from the article above",
...
- "band" is a wide image that introduces a section; use it with "before-heading" or "end-of-section". "inline-left" and "inline-right" are narrow images that body text wraps around; use them with "after-intro" or "end-of-section". Never pair "before-heading" with an inline layout.
...
- Output valid JSON only inside the block. No trailing commas, no comments.`;
}
